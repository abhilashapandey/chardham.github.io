<?php
// Team Content
$title_opt = WiguardFamework::wiguard_static_theme_mod('team-title-opt');
$team_layout = WiguardFamework::wiguard_static_theme_mod('cpt-team-layout');
		...
		<div class="col-md-12">
			...
			<div class="team-info">
				<div class="team-info-inner">
					...
					<?php
						$desg = get_post_meta( get_the_ID(), 'wiguard_team_designation', true ); 
						if( $desg ):
					?>
					...
					<?php
						$email = get_post_meta( get_the_ID(), 'wiguard_team_email', true ); 
						if( $email ):
					?>
