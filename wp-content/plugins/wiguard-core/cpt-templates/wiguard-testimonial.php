<?php
// Testimonial Content
$title_opt = WiguardFamework::wiguard_static_theme_mod('testimonial-title-opt');
...
?>
	...
	<div class="testimonial">
		<div class="testimonial-content-wrap">
			...
			<?php 
				$rate = get_post_meta( get_the_ID(), 'wiguard_testimonial_rating', true ); 
				if( $rate ) :
			?>
			<div class="testimonial-rating">
				<?php echo wiguard_star_rating( $rate );	?>
			</div>
		...
		<div class="testimonial-info">
			...
			<?php
				$desg = get_post_meta( get_the_ID(), 'wiguard_testimonial_designation', true ); 
				if( $desg ):
			?>
				<div class="testimonial-designation-wrap">
					<span class="testimonial-designation"><?php echo esc_html( $desg ); ?></span>				
					<?php
						$company = get_post_meta( get_the_ID(), 'wiguard_testimonial_company_name', true ); 
						if( $company ):
							$url = get_post_meta( get_the_ID(), 'wiguard_testimonial_company_url', true ); 
							if( $url ):
						?>
