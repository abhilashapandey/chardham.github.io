...
class DragDrop_Control extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		...
		// Scripts
		wp_register_script( 'jqueryui', WIGUARD_CORE_URL . 'elementor-supports/assets/js/jqueryui.js', [], null, true );
		wp_register_script( 'wiguard-control-helper', WIGUARD_CORE_URL . 'elementor-supports/assets/js/front-end/control-helper.js', [ 'jquery', 'jqueryui' ], '1.0.0' );
		wp_enqueue_script( 'wiguard-control-helper' );
		
		// Styles
		wp_register_style( 'wiguard-control-helper', WIGUARD_CORE_URL . 'elementor-supports/assets/css/front-end/control-helper.css', [], '3.4.1' );
		wp_enqueue_style( 'wiguard-control-helper' );
	}
