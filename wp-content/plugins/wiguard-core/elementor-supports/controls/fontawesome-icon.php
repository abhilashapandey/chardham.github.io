	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="elementor-control-fa-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo __( 'Select Icon', 'wiguard-core' ); ?>" style="font-family: 'FontAwesome';">
					<?php

						$menu_ico = wiguard_menuFaIcons();
