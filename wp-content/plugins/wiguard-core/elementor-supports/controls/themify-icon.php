	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="elementor-control-ti-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo __( 'Select Icon', 'wiguard-core' ); ?>" style="font-family: 'themify';">
					<option value=""><?php echo __( 'Select Icon', 'wiguard-core' ); ?></option>
