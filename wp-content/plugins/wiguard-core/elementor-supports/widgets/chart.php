<?php
/**
 * Wiguard Elementor Addon Chart Widget
 *
 * @since 1.0.0
 */
class Elementor_Chart_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				"description"	=> esc_html__( "Default chart options.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"extra_class",
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you put the chart title.", "wiguard-core" ),
				"default" 		=> esc_html__( "Chart", "wiguard-core" ),
			]
		);
		$this->add_control(
			"chart_width",
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Chart Width", "wiguard-core" ),
				"description"	=> esc_html__( "Here you can specify chart width. Example 800", "wiguard-core" ),
				"default" 		=> "800"
			]
		);
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Chart Height", "wiguard-core" ),
				"description"	=> esc_html__( "Here you can specify chart height. Example 300", "wiguard-core" ),
				"default" 		=> "300"
			]
		);
		$this->add_control(
			"chart_type",
			[
				"label"			=> esc_html__( "Chart Type", "wiguard-core" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"default"		=> "pie",
				"options"		=> [
					"pie"		=> esc_html__( "Pie Chart", "wiguard-core" ),
					"doughnut"	=> esc_html__( "Doughnut Chart", "wiguard-core" ),
					"bar"		=> esc_html__( "Bar Chart", "wiguard-core" ),
					"line"		=> esc_html__( "Line Chart", "wiguard-core" )
				]
			]
		);
		$this->add_control(
			"yaxis_zorobegining",
			[
				"label" 		=> esc_html__( "Y-Axis Zero Beginning", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for set y-axis zero value beginning.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "1",
				"condition" 	=> [
		...
		$this->add_control(
			...
			[
				...
				"label"			=> esc_html__( "Chart Background", "wiguard-core" ),
				"description"	=> esc_html__( "Here you can specify chart background color. Example #1555bd", "wiguard-core" ),
				"default" 		=> "#1555bd",
				"condition" 	=> [
					"chart_type" 	=> "line"
				]
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::COLOR,
				"label"			=> esc_html__( "Chart Border", "wiguard-core" ),
				"description"	=> esc_html__( "Here you can specify chart border color. Example #4580e0", "wiguard-core" ),
				"default" 		=> "#1555bd",
				"condition" 	=> [
					"chart_type" 	=> "line"
				]
		...
		$this->add_control(
			"chart_fill",
			[
				"label" 		=> esc_html__( "Chart Fill", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for fill chart.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "1",
				"condition" 	=> [
					"chart_type" 	=> "line"
		...
		$this->add_control(
			"chart_responsive",
			[
				"label" 		=> esc_html__( "Chart Responsive", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for responsive chart.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "1"
			]
		);
		$this->add_control(
			"legend_position",
			[
				"label"			=> esc_html__( "Chart Legend Position", "wiguard-core" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"default"		=> "top",
				"options"		=> [
		...
		$repeater->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Chart Label", "wiguard-core" ),
				"description"	=> esc_html__( "Chart item label.", "wiguard-core" )
			]
		);	
		$repeater->add_control(
			"chart_values",
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Chart Value", "wiguard-core" ),
				"description"	=> esc_html__( "Chart item value.", "wiguard-core" )
			]
		);	
		$repeater->add_control(
			"chart_colors",
			[
				"type"			=> \Elementor\Controls_Manager::COLOR,
				"label" 		=> esc_html__( "Chart Color", "wiguard-core" ),
				"description"	=> esc_html__( "Chart item color.", "wiguard-core" )
			]
		);	
		$this->add_control(
			"chart_details",
			[
				"label"			=> esc_html__( "Chart Details", "wiguard-core" ),
				"description"	=> esc_html__( "This is options for put chart item labels and values.", "wiguard-core" ),
				"type"			=> \Elementor\Controls_Manager::REPEATER,
				"fields"		=> $repeater->get_controls(),
				"default"		=> [
					[
						"chart_labels" 	=> esc_html__( "HTML", "wiguard-core" ),
						"chart_values"	=> "25",
						"chart_colors"	=> "#FF3D67"
					],
					[
						"chart_labels" 	=> esc_html__( "PHP", "wiguard-core" ),
						"chart_values"	=> "30",
						"chart_colors"	=> "#36A2EB"
					],
					[
						"chart_labels" 	=> esc_html__( "WordPress", "wiguard-core" ),
						"chart_values"	=> "45",
						"chart_colors"	=> "#FFCE56"
					]
				],
	...
	protected function render() {
		...
		$chart_rand_id = $rand_class = 'chart-rand-' . wiguard_shortcode_rand_id();
