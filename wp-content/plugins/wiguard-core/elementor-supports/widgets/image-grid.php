<?php
/**
 * Wiguard Elementor Addon Image grid
 *
 * @since 1.0.0
 */
class Elementor_Image_Grid_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( "Image Grid", "wiguard-core" );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			"grid_cols",
			[
				"label"			=> esc_html__( "Image Grid Columns", "wiguard-core" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"description"	=> esc_html__( "This grid option using to divide columns as per given numbers. This option active only when slide inactive otherwise slide columns only focus to divide.", "wiguard-core" ),
				"default"		=> "3",
				"options"		=> [
		...
		$this->add_control(
			"image_grid_style",
			[
				"label"			=> esc_html__( "Image Grid Style", "wiguard-core" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"description"	=> esc_html__( "Choose image grid style.", "wiguard-core" ),
				"default"		=> "1",
				"options"		=> [
		...
		$this->add_control(
			"gallery",
			[
				"label"		=> esc_html__( "Add Images", "wiguard-core" ),
		...
		$this->add_control(
			"caption_opt",
			[
				"label" 		=> esc_html__( "Image Caption Option", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for show image caption if exists.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider option.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slide items shown on large devices.", "wiguard-core" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slide items shown on tab.", "wiguard-core" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slide items shown on mobile.", "wiguard-core" ),
				"default" 		=> "1",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider auto play.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider loop.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider center, for this option must active loop and minimum items 2.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider navigation.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider pagination.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider margin space.", "wiguard-core" ),
				"default" 		=> "",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider duration.", "wiguard-core" ),
				"default" 		=> "5000",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider smart speed.", "wiguard-core" ),
				"default" 		=> "250",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for image grid slider scroll by.", "wiguard-core" ),
				"default" 		=> "1",
			]
		);
		$this->end_controls_section();
							...
							echo'<div class="image-grid-inner">';
								...
								if( $thumb_size == 'custom' ){
									if( strpos( $cus_thumb_size, ";" ) ){
										...
										$img_prop = wiguard_get_custom_size_image( $custom_opt, $hard_crop, $image_id );
								...
								$image_alt = $image_alt == '' ? esc_html__( 'Image', 'wiguard-core' ) : $image_alt;
