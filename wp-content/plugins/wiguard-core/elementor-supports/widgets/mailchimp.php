...
class Elementor_Mailchimp_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Mailchimp', 'wiguard-core' );
	}
	...
	protected function _register_controls() {
		...
		$mailchimp_list_ids = function_exists( 'wiguard_get_mailchimp_list_ids' ) ? wiguard_get_mailchimp_list_ids() : array();
		...
		$this->start_controls_section(
			...
			[
				...
				"description"	=> esc_html__( "Default mailchimp options.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"title",
			[
				...
				"description"	=> esc_html__( "This is mailchimp title.", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "mailchimp layout options available here.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"mailchimp_heading",
		...
		$this->add_control(
			...
			[
				...
				"default" 		=> esc_html__( "Layouts", "wiguard-core" ),
				'selectors' => [
		...
		$this->add_control(
			"mailchimp_layout",
			[
				"label"			=> esc_html__( "Mailchimp Layout", "wiguard-core" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"default"		=> "default",
				"options"		=> [
		...
		$this->start_controls_section(
			"mailchimp_section",
			[
				"label"			=> esc_html__( "Mailchimp", "wiguard-core" ),
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "mailchimp options available here.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"mailchimp_list",
			[
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"label"			=> esc_html__( "Select a Mailing List", "wiguard-core" ),
				"description"	=> esc_html__( "This mailchimp list's showing by given mailchimp api key from theme options.", "wiguard-core" ),
				"default"		=> "",
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"label"			=> esc_html__( "Signup Button Style", "wiguard-core" ),
				"description"	=> esc_html__( "This is an option for mailchimp button style.", "wiguard-core" ),
				"default" 		=> "text",
				"options"		=> [
					"text"	=> esc_html__( "Only Text", "wiguard-core" ),
					"icon"	=> esc_html__( "Only Icon", "wiguard-core" ),
					"text-icon"	=> esc_html__( "Text with Icon", "wiguard-core" ),
				]
			]
		);
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Signup Button Text", "wiguard-core" ),
				"description"	=> esc_html__( "This is the option for mailchimp singup button text. If no text need, then leave it empty.", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Placeholder Text", "wiguard-core" ),
				"description"	=> esc_html__( "This is for placeholder text.", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->add_control(
			"first_name",
			[
				"label" 		=> esc_html__( "First Name Field", "wiguard-core" ),
				"description"	=> esc_html__( "This is an option for collect first name.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			"last_name",
			[
				"label" 		=> esc_html__( "Last Name Field", "wiguard-core" ),
				"description"	=> esc_html__( "This is an option for collect last name.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This subtitle text show below of mailchimp title.", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Success Text", "wiguard-core" ),
				"description"	=> esc_html__( "This success message text for mailchimp.", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Failed Text", "wiguard-core" ),
				"description"	=> esc_html__( "This failed message text for mailchimp.", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		$success_text = isset( $success_text ) && $success_text != '' ? $success_text : esc_html__( 'Success', 'wiguard-core' );
		$fail_text = isset( $fail_text ) && $fail_text != '' ? $fail_text : esc_html__( 'Failed', 'wiguard-core' );
		
		$shortcode_rand_id = 'zozo-mc-form-'. wiguard_shortcode_rand_id();
		...
		<div class="mailchimp-wrapper">
			<form class="zozo-mc-form" id="<?php echo esc_attr( $shortcode_rand_id ); ?>" method="post">
				...
				<?php } ?>
				<input type="hidden" name="wiguard_mc_listid" value="<?php echo esc_attr( $mailchimp_list ); ?>" />
