<?php
/**
 * Wiguard Elementor Addon Portfolio Widget
 *
 * @since 1.0.0
 */
class Elementor_Portfolio_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( "Portfolio", "wiguard-core" );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				"description"	=> esc_html__( "Default portfolio options.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"extra_class",
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Portfolio layout options here available.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"heading_tag",
		...
		$this->add_control(
			"title_link",
			[
				"label"			=> esc_html__( "Title Link", "wiguard-core" ),
				"description"	=> esc_html__( "Enabel portfolio title as link or text.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "1"
			]
		);
		...
		$this->add_control(
			"portfolio_masonry",
			[
				"label" 		=> esc_html__( "Portfolio Masonry", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for portfolio masonry or normal.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0",
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Portfolio Masonry Gutter", "wiguard-core" ),
				"description"	=> esc_html__( "Here you can mention portfolio masonry gutter size. Example 30", "wiguard-core" ),
				"default" 		=> "10",
				"condition" 	=> [
					"portfolio_masonry" 		=> "1",
					"portfolio_layout!" 		=> "list"
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Enabel to show portfolio filter by category.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0",
				"condition" 	=> [
					"portfolio_masonry" => "1",
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can mention portfolio's first filter text.", "wiguard-core" ),
		...
		$this->add_control(
			"portfolio_infinite",
			[
				"label"			=> esc_html__( "Portfolio Masonry Infinite", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for portfolio masonry infinite scroll.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0",
				"condition" 	=> [
					"portfolio_masonry" => "1",
		...
		$this->add_control(
			...
			[
				...
				"default" 		=> esc_html__( "Loading portfolios..", "wiguard-core" ),
				"condition" 	=> [
		...
		$this->add_control(
			...
			[
				...
				"default" 		=> esc_html__( "No more portfolios.", "wiguard-core" ),
				"condition" 	=> [
					"portfolio_infinite" 		=> "1",
					"portfolio_layout!" 		=> "list"
				]
		...
		$this->add_control(
			...
			[
				"label" 		=> esc_html__( "Portfolio Pagination", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0",
				"condition" 	=> [
					"portfolio_masonry" 		=> "0"
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"label"			=> esc_html__( "Portfolio Variation", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for portfolio variatoin either dark or light.", "wiguard-core" ),
				"default"		=> "light",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"label"			=> esc_html__( "Portfolio Columns", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for portfolio columns.", "wiguard-core" ),
				"default"		=> "6",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				"label"				=> "Post Items",
				"description"		=> esc_html__( "This is settings for portfolio custom layout. here you can set your own layout. Drag and drop needed portfolio items to Enabled part.", "wiguard-core" ),
				"type"				=> "dragdrop",
				"ddvalues" 			=> [ 
					"Enabled" 		=> [ 
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is an option for overlay items position.", "wiguard-core" ),
				"default"		=> "center",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is settings for portfolio shortcode post overlay items.", "wiguard-core" ),
				"type"			=> "dragdrop",
				"ddvalues"		=> [ 
					...
					esc_html__( "disabled", "wiguard-core" ) => [
						...
						"top-meta"		=> esc_html__( "Top Meta", "wiguard-core" ),
						"bottom-meta"	=> esc_html__( "Bottom Meta", "wiguard-core" ),
						'popup'	=> esc_html__( 'Popup Icon', 'wiguard-core' ),
						'link'	=> esc_html__( 'Link', 'wiguard-core' ),
						'icons'	=> esc_html__( 'Popup and Link', 'wiguard-core' )
					]
				],
				"condition" 	=> [
					"post_overlay_items_opt" 		=> "1"
		...
		$this->add_control(
			...
			[
				"label"			=> "Post Top Meta",
				"description"	=> esc_html__( "This is settings for portfolio shortcode post top meta.", "wiguard-core" ),
				"type"			=> "dragdrop",
				"ddvalues"		=> [ 
					...
					esc_html__( "disabled", "wiguard-core" ) => [
						...
						'date'	=> esc_html__( 'Date', 'wiguard-core' ),
						'link'	=> esc_html__( 'Link', 'wiguard-core' ),
						'popup'	=> esc_html__( 'Popup', 'wiguard-core' ),
						'icons'	=> esc_html__( 'Popup and Link', 'wiguard-core' )
					]
				]
			]
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is settings for portfolio shortcode post bottom meta.", "wiguard-core" ),
				"type"			=> "dragdrop",
				"ddvalues"		=> [ 
					esc_html__( "Left", "wiguard-core" ) => [],
					esc_html__( "Right", "wiguard-core" ) => [],
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio text align.", "wiguard-core" ),
				"default"		=> "default",
				"options"		=> [
					"default"	=> esc_html__( "Default", "wiguard-core" ),
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Portfolio slide options here available.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"slide_opt",
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider option.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slide items shown on large devices.", "wiguard-core" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slide items shown on tab.", "wiguard-core" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slide items shown on mobile.", "wiguard-core" ),
				"default" 		=> "1",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider auto play.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider loop.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider center, for this option must active loop and minimum items 2.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider navigation.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider pagination.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider margin space.", "wiguard-core" ),
				"default" 		=> "",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider duration.", "wiguard-core" ),
				"default" 		=> "5000",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider smart speed.", "wiguard-core" ),
				"default" 		=> "250",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for portfolio slider scroll by.", "wiguard-core" ),
				"default" 		=> "1",
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can mention each portfolio items bottom space if you want to set default space of any item just use hyphen(-). Example 10px 20px - 10px", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		if ( $query->have_posts() ) {
			...
			if( $slide_opt ) {
				...
				$loading_end = isset( $loading_end ) && $loading_end != '' ? $loading_end : esc_html__( 'No more portfolios..', 'wiguard-core' );
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				}elseif( $portfolio_masonry && $isotope_filter && $filter_catoutput != '' ){
					...
					echo '<div class="portfolio-inner">';
						...
						if( $list_layout ){
							echo '<div class="media">';
								echo $this->wiguard_portfolio_shortcode_elements('thumb', $portfolio_array);
						...
						if( isset( $elemetns['Enabled'] ) ) :
							foreach( $elemetns['Enabled'] as $element => $value ){
								...
								echo $this->wiguard_portfolio_shortcode_elements( $element, $portfolio_array );
							}
						endif;
	...
	function wiguard_portfolio_shortcode_elements( $element, $opts = array() ){
		$output = '';
		switch( $element ){
							...
							if( $overlay_opt ){
								...
								$output .= '<div class="post-overlay-items'. esc_attr( $overlay_class ) .'">';
									foreach( $post_overlay_items['Enabled'] as $element => $value ){
										$output .= $this->wiguard_portfolio_shortcode_elements( $element, $opts );
									}
								$output .= '</div>';
					...
					if( isset( $ele_part ) && !empty( $ele_part ) && $ele_key != 'disabled' ) :
						...
						$output .= '<ul class="nav top-meta-list'. esc_attr( $part_class ) .'">';
							foreach($ele_part as $element => $value ){
								...
								$output .= '<li>'. $this->wiguard_portfolio_shortcode_elements( $element, $portfolio_array ) .'</li>';
							}
						$output .= '</ul>';
					endif;
				}
			...
			case "icons":
				$output .= '<div class="portfolio-icons">';
					$output .= $this->wiguard_portfolio_shortcode_elements( 'popup', $opts );
					$output .= $this->wiguard_portfolio_shortcode_elements( 'link', $opts );
			...
			case "popup":
				...
				$output .= '<div class="portfolio-popup-icon">';
					$output .= '<a href="#" data-mfp-src="'. esc_url( wp_get_attachment_url( get_post_thumbnail_id() ) ) .'" class="image-gallery-link zoom-icon"><i class="ti-zoom-in"></i></a>';
