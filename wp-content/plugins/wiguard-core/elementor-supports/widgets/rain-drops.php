...
class Elementor_RainDrops_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Rain Drops', 'wiguard-core' );
	}
	...
	protected function render() {
		...
		echo '<div class="rain-drops-elementor-widget">';
			...
			echo '<div class="wiguard-rain-drops" id="example-'. esc_attr( $this->uniqid_gen() ) .'" data-color="'. esc_attr( $rd_color ) .'" data-height="'. esc_attr( $rd_height ) .'" data-speed="'. esc_attr( $rd_speed ) .'" data-freq="'. esc_attr( $rd_freq ) .'" data-density="'. esc_attr( $rd_density ) .'" data-position="'. esc_attr( $rd_pos ) .'"></div>';
