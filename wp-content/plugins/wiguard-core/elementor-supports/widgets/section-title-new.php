...
class Elementor_Section_Title_Widget extends \Elementor\Widget_Base {
	...
	private function get_separator_styles() {
		return array_merge(
			...
			[
				...
				'parallelogram'   => [
					'label' => _x( 'Parallelogram', 'shapes', 'cea' ),
				...
				'rectangles'   => [
					'label' => _x( 'Rectangles', 'shapes', 'cea' ),
				...
				'rounds_tribal'   => [
					'label' => _x( 'Half Rounds', 'shapes', 'cea' ),
	...
	private function get_options_by_groups( $styles, $group = false ) {
		$groups = [
			'line' => [
				...
				'options' => [
					'solid' => __( 'Solid', 'cea' ),
					'double' => __( 'Double', 'cea' ),
					'dotted' => __( 'Dotted', 'cea' ),
					'dashed' => __( 'Dashed', 'cea' ),
				],
			],
		];
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Prefix Title", "cea" ),
				"description"	=> esc_html__( "Enter section title prefix. If no need title prefix, then leave this box blank.", "cea" )
			]
		);
		$this->add_control(
			"title",
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Main Title", "cea" ),
				"description"	=> esc_html__( "Enter section title here.", "cea" ),
				"default"		=> esc_html__( "Section Title", "cea" )
			]
		);			
		$this->add_control(
			"title_suffix",
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Suffix Title", "cea" ),
				"description"	=> esc_html__( "Enter section title suffix. If no need title suffix, then leave this box blank.", "cea" )
			]
		);	
		$this->add_control(
			"title_head",
			[
				"label"			=> esc_html__( "Modal Box Title Heading Tag", "cea" ),
				"description"	=> esc_html__( "Here you can choose the section title box title heading tag.", "cea" ),
		...
		$this->start_controls_section(
			"subtitle_section",
			[
				"label"			=> esc_html__( "Sub Title", "cea" ),
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Sub title options available here.", "cea" ),
			]
		);
		$this->add_control(
			"sub_title",
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Sub Title", "cea" ),
				"description"	=> esc_html__( "Enter section title here. If no need sub title, then leave this box blank.", "cea" )
			]
		);
		$this->add_control(
			"sub_title_head",
			[
				"label"			=> esc_html__( "Sub Title Heading Tag", "cea" ),
				"description"	=> esc_html__( "Here you can choose the section sub title heading tag.", "cea" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"default"		=> "h6",
				"options"		=> [
					"h1"		=> esc_html__( "h1", "cea" ),
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"label"			=> esc_html__( "Sub Title Position", "cea" ),
				"description"	=> esc_html__( "This is option for positioning sub title.", "cea" ),
				"default"		=> "bottom",
				"options"		=> [
					"bottom"	=> esc_html__( "Bottom", "cea" ),
		...
		$this->start_controls_section(
			"subtitle_lead",
			[
				"label"			=> esc_html__( "Lead", "cea" ),
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Lead text options available here.", "cea" ),
			]
		);
		$this->add_control(
			"lead_text",
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Lead Text", "cea" ),
				"description"	=> esc_html__( "Enter section lead text here.", "cea" )
			]
		);
		$this->add_control(
			"lead_tag",
		...
		$this->start_controls_section(
			"separator_section",
			[
				"label"			=> esc_html__( "Separator", "cea" ),
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Separator options available here.", "cea" ),
			]
		);
		$this->add_control(
			"sep_model",
			[
				...
				"description"	=> esc_html__( "This is section title seperator type.", "cea" ),
				"default"		=> "none",
				"options"		=> [
					"none"		=> esc_html__( "None", "cea" ),
					"pattern"	=> esc_html__( "Border/Pattern", "cea" ),
		...
		$this->add_control(
			"sep_pattern",
			[
				"label"			=> esc_html__( "Border/Shape", "cea" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Content options available here.", "cea" ),
			]
		);
		$this->add_control(
			"sec_tit_content",
			[
				...
				"label"			=> esc_html__( "Content", "cea" ),
				"description"	=> esc_html__( "Enter section title below content.", "cea" ),
				"default" 		=> ""
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			"btn_enabled",
			[
				"label" 		=> esc_html__( "Enable Button", "cea" ),
				"description"	=> esc_html__( "This is option for enable button on section title.", "cea" ),
		...
		$this->add_control(
			...
			[
				...
				"label"			=> esc_html__( "Title Prefix Color", "cea" ),
				"description"	=> esc_html__( "Here you can put the prefix title font color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can put the main title font color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::COLOR,
				"label"			=> esc_html__( "Title Suffix Color", "cea" ),
				"description"	=> esc_html__( "Here you can put the suffix title font color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::COLOR,
				"label"			=> esc_html__( "Sub Title Color", "cea" ),
				"description"	=> esc_html__( "Here you can put the sub title font color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_responsive_control(
			'sub_title_spacing',
			[
				'label' => esc_html__( 'Sub Title Spacing', 'cea' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::COLOR,
				"label"			=> esc_html__( "Lead Text Color", "cea" ),
				"description"	=> esc_html__( "Here you can put the lead font color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		$this->add_responsive_control(
			'lead_spacing',
			[
				'label' => esc_html__( 'Content Spacing', 'cea' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::COLOR,
				"label"			=> esc_html__( "Content Color", "cea" ),
				"description"	=> esc_html__( "Here you can put the content font color.", "cea" ),
				"default" 		=> "",
				'selectors' => [
		...
		echo '<div class="section-title-wrapper'. esc_attr( $class ) .'">';
			...
			echo '<div class="title-wrap">';
				...
				if( $sep_model == 'pattern' ){					
					...
					echo '<div '. $this->get_render_attribute_string( 'seperator_wrapper' ) .'><span class="elementor-divider-separator"></div></div>';
					...
					if ( $is_new || $migrated ) :
						\Elementor\Icons_Manager::render_icon( $settings['sep_icon'], [ 'aria-hidden' => 'true' ] );
					else :
