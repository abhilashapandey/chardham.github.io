<?php
/**
 * Wiguard Elementor Addon Testimonial Widget
 *
 * @since 1.0.0
 */
class Elementor_Testimonial_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( "Testimonial", "wiguard-core" );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				"description"	=> esc_html__( "Default testimonial options.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"extra_class",
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Testimonial filter options here available.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"testimonial_ids",
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label"			=> esc_html__( "Enter Testimonial Id's", "wiguard-core" ),
				"description"	=> esc_html__( "Here you can enter testimonial post id's for get specific testimonial. Example 4, 5, 7", "wiguard-core" ),
				"default" 		=> ''
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Testimonial layout options here available.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"heading_tag",
		...
		$this->add_control(
			"testimonial_layout",
			[
				"label"			=> esc_html__( "Testimonial Layout", "wiguard-core" ),
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"default"		=> "default",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"label"			=> esc_html__( "Testimonial Variation", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for testimonial variatoin either dark or light.", "wiguard-core" ),
				"default"		=> "light",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::SELECT,
				"label"			=> esc_html__( "Testimonial Columns", "wiguard-core" ),
				"description"	=> esc_html__( "This is option for testimonial columns.", "wiguard-core" ),
				"default"		=> "6",
				"options"		=> [
		...
		$this->add_control(
			...
			[
				"label"				=> "Post Items",
				"description"		=> esc_html__( "This is settings for testimonial custom layout. here you can set your own layout. Drag and drop needed testimonial items to Enabled part.", "wiguard-core" ),
				"type"				=> "dragdrop",
				"ddvalues" 			=> [ 
					"Enabled" 		=> [ 
						...
						"rate"			=> esc_html__( "Star Rating", "wiguard-core" ),
						"info"			=> esc_html__( "Client Info", "wiguard-core" )
					],
					"disabled"		=> [
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial text align.", "wiguard-core" ),
				"default"		=> "center",
				"options"		=> [
					"default"	=> esc_html__( "Default", "wiguard-core" ),
		...
		$this->start_controls_section(
			...
			[
				...
				"tab"			=> \Elementor\Controls_Manager::TAB_CONTENT,
				"description"	=> esc_html__( "Testimonial slide options here available.", "wiguard-core" ),
			]
		);
		$this->add_control(
			"slide_opt",
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider option.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slide items shown on large devices.", "wiguard-core" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slide items shown on tab.", "wiguard-core" ),
				"default" 		=> "2",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slide items shown on mobile.", "wiguard-core" ),
				"default" 		=> "1",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider auto play.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider loop.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider center, for this option must active loop and minimum items 2.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider navigation.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider pagination.", "wiguard-core" ),
				"type" 			=> "toggleswitch",
				"default" 		=> "0"
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider margin space.", "wiguard-core" ),
				"default" 		=> "",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider duration.", "wiguard-core" ),
				"default" 		=> "5000",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider smart speed.", "wiguard-core" ),
				"default" 		=> "250",
			]
		);
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "This is option for testimonial slider scroll by.", "wiguard-core" ),
				"default" 		=> "1",
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				"description"	=> esc_html__( "Here you can mention each testimonial items bottom space if you want to set default space of any item just use hyphen(-). Example 10px 20px - 10px", "wiguard-core" ),
				"default" 		=> ""
			]
		);
		$this->end_controls_section();
						...
						if( $slide_opt ){
							...
							if( isset( $elemetns['Enabled'] ) ) :
								foreach( $elemetns['Enabled'] as $element => $value ){
									echo $this->wiguard_testimonial_shortcode_elements( $element, $testimoanil_array );
								}
							endif;
					...
					while ( $query->have_posts() ) : $query->the_post();
						...
						if( $slide_opt ){
							...
							echo '<div class="media testimonial-list-item">';
								...
								echo $this->wiguard_testimonial_shortcode_elements( 'thumb', $testimoanil_array );
	...
	function wiguard_testimonial_shortcode_elements( $element, $opts = array() ){
		$output = '';
		switch( $element ){
			...
			case "designation":
				$designation = get_post_meta( $opts['post_id'], 'wiguard_testimonial_designation', true );
				if( $designation ) :
			...
			case "info":
				$output .= '<div class="testimonial-info">';
					$output .= '<div class="testimonial-info-inner">';
						$output .= '<h4><span class="client-name">'. esc_html( get_the_title() ) .'</span></h4>';
						$designation = get_post_meta( $opts['post_id'], 'wiguard_testimonial_designation', true );
						if( $designation ) :
							$output .= '<span class="client-designation">'. esc_html( $designation ) .'</span>';
						endif;
						$company_url = get_post_meta( $opts['post_id'], 'wiguard_testimonial_company_url', true );
						if( $company_url ) :
			...
			case "rate":
				$rate = get_post_meta( $opts['post_id'], 'wiguard_testimonial_rating', true );
				if( $rate ) :
					$output .= '<div class="testimonial-rating">';
						$output .= '<p>'. wiguard_star_rating( $rate ) .'</p>';
