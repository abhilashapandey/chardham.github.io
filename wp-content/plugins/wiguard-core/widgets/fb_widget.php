<?php
add_action( 'widgets_init', 'wiguard_zozo_fb_like_widget' );
function wiguard_zozo_fb_like_widget() {
	register_widget( 'wiguard_zozo_fb_widget' );
}
class wiguard_zozo_fb_widget extends WP_Widget {
	/**
	 * Widget setup.
	 */
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'zozo_fb_widget', 'description' => esc_html__('A widget that displays your latest posts from all categories or a certain', 'wiguard-core') );
		/* Widget control settings. */
		$control_ops = array('id_base' => 'zozo_fb_widget' );
		/* Create the widget. */
		parent::__construct( 'zozo_fb_widget', esc_html__('Facebook Like', 'wiguard-core'), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('FB Like', 'wiguard-core'), 'fblink' => '', 'fbname' => '');
		...
		<!-- Fb like Name -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fbname' ) ); ?>"><?php esc_html_e('Facebook Profile Name:', 'wiguard-core'); ?></label>
		...
		<!-- Fb like Link -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fblike' ) ); ?>"><?php esc_html_e('Facebook Link:', 'wiguard-core'); ?></label>
