...
$settings = array(
	...
	'description'	=> esc_html__( 'This is settings for archive page layout, sidebar sticky and etc.', 'wiguard' ),
	'section_stat'	=> true
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'type'			=> 'radioimage',
	'title'			=> esc_html__( 'Archive Post Template', 'wiguard' ),
	'description'	=> esc_html__( 'Choose your current archive post template.', 'wiguard' ),
	'default'		=> 'standard',
	'items' 		=> array(
...
$settings = array(
	...
	'type'			=> 'text',
	'title'			=> esc_html__( 'Archive Post Grid Gutter', 'wiguard' ),
...
$settings = array(
	...
	'description'	=> esc_html__( 'Enable/Disable infinite scroll for archive post.', 'wiguard' ),
	'default'		=> 0,
	'refresh'		=> 1
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'description'	=> esc_html__( 'Set archive post excerpt length. Example 15', 'wiguard' ),
	'default'		=> '15',
	'refresh'		=> 1
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'type'			=> 'dragdrop',
	'title'			=> esc_html__( 'Archive Post Top Meta Items', 'wiguard' ),
	'description'	=> esc_html__( 'Needed archive post top meta items drag from disabled and put enabled part. ie: Left or Right.', 'wiguard' ),
	'default' 		=> array(
		'Left'  => array(
...
$settings = array(
	...
	'type'			=> 'dragdrop',
	'title'			=> esc_html__( 'Archive Post Bottom Meta Items', 'wiguard' ),
	'description'	=> esc_html__( 'Needed archive post bottom meta items drag from disabled and put enabled part. ie: Left or Right.', 'wiguard' ),
	'default' 		=> array(
		'Left'  => array(
			'more'		=> esc_html__( 'Read More', 'wiguard' ),
		),
...
$settings = array(
	'id'			=> 'archive-items',
	'type'			=> 'dragdrop',
	'title'			=> esc_html__( 'Archive Post Items', 'wiguard' ),
	'description'	=> esc_html__( 'Needed archive post items drag from disabled and put enabled part. Thumbnail part covers the post format either image/audio/video/gallery/quote/link.', 'wiguard' ),
	'default' 		=> array(
		'Enabled'  		=> array(
...
$settings = array(
	...
	'type'			=> 'toggle',
	'title'			=> esc_html__( 'Archive Post Overlay', 'wiguard' ),
	'description'	=> esc_html__( 'Enable/Disable archive post overlay.', 'wiguard' ),
	'default'		=> 0,
	'refresh'		=> 1
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'type'			=> 'dragdrop',
	'title'			=> esc_html__( 'Archive Post Overlay Items', 'wiguard' ),
	'description'	=> esc_html__( 'Needed archive post overlay items drag from disabled and put enabled part.', 'wiguard' ),
	'default' 		=> array(
		'Enabled'  	=> array(
			'title'			=> esc_html__( 'Title', 'wiguard' ),
		),
...
$settings = array(
	...
	'type'			=> 'link',
	'title'			=> esc_html__( 'Archive Template Link Color', 'wiguard' ),
	'description'	=> esc_html__( 'Choose archive template link color.', 'wiguard' ),
	'default'		=> '',
	'required'		=> array( 'archive-page-title-opt', '=', 1 ),
	'refresh'		=> 1
);
...
$settings = array(
	...
	'type'			=> 'border',
	'title'			=> esc_html__( 'Archive Template Border', 'wiguard' ),
...
$settings = array(
	...
	'type'			=> 'dimension',
	'title'			=> esc_html__( 'Archive Template Padding Option', 'wiguard' ),
...
$settings = array(
	...
	'type'			=> 'background',
	'title'			=> esc_html__( 'Archive Template Background', 'wiguard' ),
...
$settings = array(
	'type'			=> 'section',
	'label'			=> esc_html__( 'Archive Article Skin Settings', 'wiguard' ),
	'description'	=> esc_html__( 'This is skin settings for each archive article.', 'wiguard' ),
	'section_stat'	=> true
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'description'	=> esc_html__( 'This is font color for archive article.', 'wiguard' ),
	'default'		=> '',
	'refresh'		=> 1
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'description'	=> esc_html__( 'Choose article link color for archive article.', 'wiguard' ),
	'default'		=> '',
	'refresh'		=> 1
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'description'	=> esc_html__( 'This is background color for archive article.', 'wiguard' ),
	'default'		=> '',
	'refresh'		=> 1
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'description'	=> esc_html__( 'Set archive post read more text. Example Read More', 'wiguard' ),
...
$settings = array(
	...
	'description'	=> esc_html__( 'This is post format settings for archive.', 'wiguard' ),
	'section_stat'	=> true
);
WiguardCustomizerConfig::buildFields( $settings );
...
$settings = array(
	...
	'description'	=> esc_html__( 'Choose archive page video post format settings.', 'wiguard' ),
	'choices'		=> array(
...
$settings = array(
	...
	'description'	=> esc_html__( 'Choose archive page quote post format settings.', 'wiguard' ),
	'choices'		=> array(
...
$settings = array(
	...
	'description'	=> esc_html__( 'Choose archive page link post format settings.', 'wiguard' ),
	'choices'		=> array(
		'featured' 		=> esc_html__( 'Dark Overlay', 'wiguard' ),
		'theme-overlay' => esc_html__( 'Theme Overlay', 'wiguard' ),
		'theme' 		=> esc_html__( 'Theme Color Background', 'wiguard' ),
...
$settings = array(
	...
	'description'	=> esc_html__( 'Choose archive page gallery post format settings.', 'wiguard' ),
	'choices'		=> array(
...
$settings = array(
	...
	'type'			=> 'toggle',
	'title'			=> esc_html__( 'Archive Featured Slider', 'wiguard' ),
	'description'	=> esc_html__( 'Enable/Disable archive featured slider.', 'wiguard' ),
	'default'		=> 0,
	'refresh'		=> 1
);
WiguardCustomizerConfig::buildFields( $settings );
