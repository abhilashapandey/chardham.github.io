...
echo '.post-type-post .editor-block-list__layout .editor-block-list__block {
	color: '. WiguardThemeStyles::wiguard_static_theme_mod( 'single-post-article-color' ) .'; }';
...
$gen_link = WiguardThemeStyles::wiguard_static_theme_mod('single-post-article-link-color');
if( $gen_link ):
echo '.post-type-post .editor-block-list__layout .editor-block-list__block a{';
	$ats->wiguard_link_color( 'single-post-article-link-color', 'regular' );
echo '
}';
echo '.post-type-post .editor-block-list__layout .editor-block-list__block a:hover{';
	$ats->wiguard_link_color( 'single-post-article-link-color', 'hover' );
echo '
}';
echo '.post-type-post .editor-block-list__layout .editor-block-list__block a:active{';
	$ats->wiguard_link_color( 'single-post-article-link-color', 'active' );
echo '
}';
endif;
