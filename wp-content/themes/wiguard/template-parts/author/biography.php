...
<div class="media author-info clearfix">
	...
	<div class="media-body author-meta">
		<div class="posts-count">
			...
			<?php else : ?>
				<h5><?php echo esc_html( $author_name );//esc_attr( $author_tot_posts ) . esc_html__(' Posts', 'wiguard'); ?></h5>
				<h6><?php echo esc_attr( $author_tot_posts ) . esc_html__(' Posts', 'wiguard'); ?></h6>
			<?php endif ; ?>
		</div>
		...
		<div class="author-bio">
			<p><?php echo wp_kses( $author_info, WiguardThemeOpt::wiguard_allowed_html_tags() ); ?></p>
