...
$cols = '';
$max_posts = WiguardThemeOpt::wiguard_static_theme_mod( 'related-max-posts' );
$filter = WiguardThemeOpt::wiguard_static_theme_mod( 'related-posts-filter' );
$gal_atts = array(
	...
	if( $terms ) {
		...
		?>
			<div class="related-slider-wrapper clearfix">
				<h4><?php echo apply_filters( 'wiguard_portfolio_related_title', esc_html__( 'Other relevent post', 'wiguard' ) ); ?></h4>
